...
\begin{itemize}
	\item 256 Zeichen für europäische Sprachen (8-Bit-Zeichencode)
	\item die ersten 128 Zeichen sind identisch zu ASCII
	\item die zweiten 128 Zeichen enthalten europäische Sonderzeichen, z.B. Umlaute
\end{itemize}
\subsubsection{Unicode}
\begin{itemize}
	\item \"uber eine Million Zeichen, verschiedene Sprachen (Arabisch, Hebräisch, Chinesisch usw.)
...
\begin{description}
	\item[Datentyp int] \hfill 
		\begin{itemize}
			...
			\item eine int-Variable kann jeden möglichen Zeichencode (code point) des Unicodes aufnehmen
		\end{itemize}
...
\begin{description}
	\item[Character-Array] \hfill \\
		ver\"anderbare Zeichenkette mit expliziter Längenangabe (Teil des Arrays)
	\item[Klasse String (UTF-16 Format)] \hfill \\
		unver\"anderbare Zeichenkette mit expliziter Längenangabe
...
\begin{description}
	...
	\item[String substring(int anfang, int ende)] \hfill \\
		Schneidet eine Zeichenkette zwischen anfang und ende –1 aus und erzeugt damit ein neues Stringobjekt. Der ursprüngliche String wird dabei nicht verändert.
...
\begin{description}
	...
	\item[Nachbedingungen (Postcondition)] \hfill \\
		...
		\begin{itemize}
			...
			\item wenn ein Programm P die speziellere Spezifikation S erfüllt, so auch die allgemeinere T
...
\begin{description}
	...
	\item[Beweisverfahren] \hfill \\
		...
		Somit ist INV an der Position 3 die Nachbedingung der Instruktionen vor der while-Schleife und wir k\"onnen mit dem üblichen Verfahren WP berechnen.
	\item[Beispiel] \hfill \\

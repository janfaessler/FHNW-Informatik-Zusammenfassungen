...
\begin{description}
	...
	\item[Ablauf:] \hfill
		\begin{itemize}
			\item solange wenigstens zwei Kugeln im Beh\"alter sind, zufällig zwei Kugeln rausnehmen und ...
	...
	\item[Gesucht] \hfill
		\begin{itemize}
			...
			\item Falls ja, wie und wovon hängt die Schlusssituation ab?
		\end{itemize}
\end{description}
...
\begin{description}
	...
	\item[Frage 2:] Bei allen drei m\"oglichen Schritten, verändert sich die Parit\"at von b nicht. Das bedeutet, dass wenn am Ende eine Schwarze Kugel \"ubrig ist muss am Anfang eine ungerade Anzahl Kugeln in dem Beh\"alter gewesen sein.
\end{description}

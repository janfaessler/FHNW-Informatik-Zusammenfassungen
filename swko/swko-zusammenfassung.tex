...
\begin{itemize}
 ...
 \item Immer einen deploy-fähigen Build haben
...
\begin{itemize}
 ...
 \item Gesharte Komponenten funktionieren nicht überall gleich
 \item Unit-Tests nicht erfolgreich
 \item Code-Qualität schlecht (Conventions, Metrics)
...
\item [I] Können inverse Beziehungen überprüft werden?
...
\begin{itemize}
	...
	\item Reales Objekt schwierig aufzusetzen
	\item Reales Objekt ist langsam
	\item Reales Objekt verfügt über GUI
	\item Der Test muss das Orginalobjekt fragen wie es war
	\item Reales Objekt existiert nicht nicht
\end{itemize}
\begin{description}
	\item[Pros] \hfill
		\begin{itemize}
...
\begin{itemize}
\item Selber-kodieren von Mock Objekten fällt weg
...
\item \textbf{\Bold Selenium WebDriver:} API um Browser programmatisch anzusteuern (z.B. aus Java, C-Sharp, PHP, Rubyâ€¦). Kann auch aufgenommene Skripts gegen andere Browser (â‰  Firefox) ausfÃ¼hren
...
\Bold {Konzepte:}
\begin{itemize}
\item Ausf\"uhrbare Use Cases und Workflowsœ
\item F\"ur Kunden/Benutzer verst\"andlich und durch diesen erstellbar
\item Konkrete Beispiele (Testing by Exampleœ)
\end{itemize}
...
Statt Fixtures.TestSearchSubmit$ \rightarrow$ žTest Search Submit

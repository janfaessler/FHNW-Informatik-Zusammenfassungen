...
\lstinputlisting[label=Ant-Script,caption=Ant-Script]{ant-script.xml}
...
\subsection{Beispiel}
\lstinputlisting[label=Unit-Test,caption=Unit-Testt]{unit-test.java}
...
\lstinputlisting[label=Mock-Test,caption=Mock-Testt]{mock-test.java}

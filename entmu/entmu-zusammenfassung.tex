...
Ein Iterator ist immer zwischen zwei Elemente. Es gibt also in einer Collection mit n Elementen, n + 1 mï¿½gliche Positionen an denen der Iterator stehen kann.
...
\begin{description}
	\item[ArrayList] \hfill \\ Eine Implementierung welche ein Array darstellt bei dem man die grösse verï¿½ndern kann.

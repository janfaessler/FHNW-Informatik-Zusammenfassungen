...
\pagebreak 
Soft-Referenzen werden beim Traversieren des Garbage Collectors zerst\"{o}rt, wenn keine weiteren harten Referenzen auf das Objekt mehr zeigen. Dies verhindert Memory-Leak durch Singleton-Patterns.
\begin{lstlisting}[language=Java, caption=Java Implementierung (freundlicher für den Garbage Collector), style=JavaStyle]
...
\begin{lstlisting}[language=Java, caption=Initialization-on-demand holder idiom, style=JavaStyle]

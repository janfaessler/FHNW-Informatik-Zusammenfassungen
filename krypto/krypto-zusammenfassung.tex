...
$A=t_0-[\sqrt{n}] \gtrsim t_0 -\sqrt{n} = \frac{p+q}{2}-\sqrt{n}=\frac{1}{2}{\color{green}(p+q-2*\sqrt{n})}$ ${\color{red} \Oben{\T{Lemma}}{<}}$ $\frac{1}{2}(\frac{\delta^2}{4*\sqrt{n}})$ ${\color{red} \Oben{\T{Vor. 2}}{<}}$ $\frac{1}{2}*\frac{c^2*(\sqrt[4]{n})^2}{4*\sqrt{n}}$ {\color{red} $=\frac{c^2}{8} < \lceil\frac{c^2}{8}\rceil$}

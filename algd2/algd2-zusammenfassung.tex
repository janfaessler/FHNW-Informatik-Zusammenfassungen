% Kann vielleicht mal jemand angeben, ob das ISO 8859-1 oder ISO 8859-15 oder vielleicht Windows-1252 sein soll?!
% Klar ist, dass es nicht UTF-8 ist, also bitte aufhören sowas einzufügen! 
% Die Frage ist z.B. wie das Euro-Zeichen eingefügt werden soll. 
% Ist es 0x80? ==> Windows-1252
% Ist es 0xA4? ==> ISO 8859-15 / Latin9
% Nicht vorhanden? ==> ISO 8859-1 / Latin1
